    ...
    <>
      <div className="main-container">
        <div className="bg-gray-100">
          <h1 className="text-3xl p-4">Snack Packing Machine</h1>
          <p className="text-lg px-4 pb-4">
            Lorem ipsum dolor sit, amet consectetur adipisicing elit.
            Repellendus aut veritatis esse dolor iusto voluptatum quam nisi rem,
            error nihil repellat et, voluptates asperiores aliquam sunt est,
            blanditiis amet saepe?
          </p>
        </div>
